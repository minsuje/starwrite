...
//   visible,
// };
function ListViewAllFeat({ postListAll }: { postListAll: Posts[] }) {
                ...
                <div key={idx}>
                  ...
                  >
                    <_postBox>
                      <h1>
                        {post.postTitle}
                        {post.originAuthor !== nickname &&
                          post.originAuthor !== null && <Badge>스크랩</Badge>}
                        {post.visible === 'false' ? (
                          <Badge>비공개</Badge>
                        ) : (
                          <Badge>공개</Badge>
...
export default ListViewAllFeat;
